...
public class GsProtocolDemoActivity extends DemoBaseActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOpenGsButton = (Button)findViewById(R.id.TakeOff);
        mAddOneWaypointButton = (Button)findViewById(R.id.AddWaypointButton1);
        mRemoveWaypointButton = (Button)findViewById(R.id.RemoveWaypointButton);
        mSetLoop = (Button)findViewById(R.id.GsSetLoop);
        mUploadWaypointButton = (Button)findViewById(R.id.setYawButton);
            ...
            case R.id.AddWaypointButton1:
                ...
                if(DJIDrone.getDroneType() == DJIDroneType.DJIDrone_Vision){
                  //north
                    ...
                    mWayPoint1.addAction(DJIGroundStationTypeDef.GroundStationOnWayPointAction.Way_Point_Action_Simple_Shot, 1);
                    mWayPoint1.addAction(DJIGroundStationTypeDef.GroundStationOnWayPointAction.Way_Point_Action_Video_Start, 0);
                    mWayPoint1.addAction(DJIGroundStationTypeDef.GroundStationOnWayPointAction.Way_Point_Action_Video_Stop,  0);
                    ...
                    mWayPoint2.addAction(DJIGroundStationTypeDef.GroundStationOnWayPointAction.Way_Point_Action_Craft_Yaw, -130);
                    ...
                    mWayPoint3.addAction(DJIGroundStationTypeDef.GroundStationOnWayPointAction.Way_Point_Action_Gimbal_Pitch, -89);
                    mTask.addWaypoint(mWayPoint3);

                    //north
//                    DJIGroundStationWaypoint mWayPoint1 = new DJIGroundStationWaypoint(homeLocationLatitude, homeLocationLongitude);
//                    mWayPoint1.action.actionRepeat = 0;
//                    mWayPoint1.altitude = 15f;
//                    mWayPoint1.heading = 0;
//                    mWayPoint1.actionTimeout = 10;
//                    mWayPoint1.turnMode = 1;
...
//
//                    //east
//                    DJIGroundStationWaypoint mWayPoint2 = new DJIGroundStationWaypoint(homeLocationLatitude, homeLocationLongitude);
//                    mWayPoint2.action.actionRepeat = 0;
//                    mWayPoint2.altitude = 20f;
//                    mWayPoint2.heading = 60;
//                    mWayPoint2.actionTimeout = 20;
//                    mWayPoint2.turnMode = 1;
//                    mWayPoint2.dampingDistance = 2.5f;
